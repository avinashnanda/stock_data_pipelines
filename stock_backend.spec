...
a = Analysis(
    ...
    hiddenimports=['duckdb', 'pandas', 'yfinance', 'langchain_openai', 'langchain', 'langchain.text_splitter', 'pdfminer', 'pdfminer.high_level', 'selenium', 'transformers', 'requests', 'tqdm', 'sklearn', 'openpyxl', 'bs4', 'plotly'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
